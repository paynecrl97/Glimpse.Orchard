...
namespace Glimpse.Orchard.Models
{
    internal static class TimelineCategories
    {
        ...
        public static TimelineCategoryItem Fields = new TimelineCategoryItem("Fields", "#AAAA39", "#808059");
        public static TimelineCategoryItem Parts = new TimelineCategoryItem("Parts", "#FFA256", "#A65A1C");
        public static TimelineCategoryItem ContentManagement = new TimelineCategoryItem("Content Manager", "#AA39AA", "#805980");
        public static TimelineCategoryItem Authorization = new TimelineCategoryItem("Authorization", "#C50080", "#800053");
    }
}